...
export default function StokCerdasPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold text-gray-900">StokCerdas</h1>
              <span className="text-primary-600 text-sm font-medium">Kelola Inventori Restoran</span>
            </div>
            <div className="flex items-center space-x-4">
